...
# anti l4
function anti-l4(){
bash <(curl -Ls https://raw.githubusercontent.com/ht4g/tool/main/antil4.sh)
...
function start_menu(){
    ...
    green " 2. Chặn Speedtest"
    yellow " ————————————————————————————————————————————————"
    green " 3. Hạ cấp xuống bản ổn định 6.8.23 (Một số chỗ tiếng Trung)"
